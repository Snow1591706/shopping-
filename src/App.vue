...
<script>
//因首页使用了jquery插件,需要下载jquery插件安装包
//网址:https://www.npmjs.com/package/jquery
//执行指令:cnpm i jquery --save
//然后导入安装包
...
//导入jquery插件鼠标器悬停上下翻动动画导航菜单里面的js代码
//网址:http://www.jq22.com/yanshi5332
//如何使用插件?
//在网站下载插件,然后样式直接导入,js代码查阅index.js里面
//将其直接复制粘贴
...
<style>
  /* 导入静态样式文件 样式导入语法:@import url(需导入文件路径)*/
